...
@Component({
    ...
    imports: [CommonModule, MatButtonModule, MatIconModule, FormsModule, MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatSortModule, MatPaginatorModule,
        MatSelectModule, MatOptionModule, FuseAlertComponent, MatCheckboxModule, CustomPipesModule, RouterModule]
})
...
*/
    ...
    private subcribeFilterForm() {
        this.filterForm.valueChanges.pipe(
            ...
            switchMap((filter) => {
                this.isLoading = true;
                this._orderService.getOrders(filter).subscribe(result => {
